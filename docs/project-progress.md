...
- 2026-03-26：新增 `docs/basic-runnable-work-plan.md`，明确“达到基本可运行状态”的阶段目标与推荐顺序，并同步调整 `docs/upcoming-work-plan.md` 的优先级。
...
- 然后继续补充功能：
  ...
  - 继续补充 relationship 规则、plan、朋友圈等领域的数据库模型与持久化逻辑
